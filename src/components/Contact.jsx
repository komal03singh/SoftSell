    ...
    <div id='Contact'>
      ...
      <div>
        <div className='ml-10 px-2'>
          <h1 className='text-4xl font-extrabold max-w-md'>QUESTIONS ? WE'RE HERE TO HELP.</h1>
          <h1 className='text-4xl mt-2 font-light text-[#7c649b] opacity-80'>Contact Us<i className="fa-solid fa-phone pl-4"></i></h1>
        </div>
        <div className='grid grid-cols-2 px-10 mt-8 '>
          <div className='bg-black text-white'>
            <form className='flex flex-col p-10' action="#">
              <label className='text-base font-light mb-2' htmlFor="name"><i className="fa-solid fa-user text-white pr-2"></i>Name</label>
              ...
              <label className='text-base font-light mb-2' htmlFor="email"><i className="fa-solid text-white pr-2 fa-envelope"></i>E-mail</label>
              <input className=' bg-white/20 backdrop-blur-2xl p-2 mb-8' type="email" id='email' placeholder='Enter your E-mail' />
              <label className='text-base font-light mb-2' htmlFor="company"><i class="fa-solid fa-building text-white pr-2"></i>Company</label>
              <input className=' bg-white/20 backdrop-blur-2xl p-2 mb-8' type="text" id='company' placeholder='Enter your company name' />
              <label className='text-base font-light mb-2' htmlFor="license"><i class="fa-solid fa-file-invoice text-white pr-2"></i>License Type</label>
              ...
              <label className='text-base font-light mb-2' htmlFor="message"><i class="fa-solid fa-message text-white pr-2"></i>Message</label>
              <textarea className=' bg-white/20 backdrop-blur-2xl p-2 font-light' rows={'5'} id="message">Enter your message . . .</textarea>
              <button className='w-1/3 mt-10 bg-white text-black font-light py-3 hover:cursor-pointer hover:translate-y-[-4px] hover:shadow-lg shadow-gray-500 duration-300 ease-in-out'>Submit</button>
            </form>
          </div>
